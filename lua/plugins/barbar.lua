return { {
	...
	keys = {
		...
		{ '<leader>wc', '<cmd>BufferClose<cr>',              desc = '[wc] Workspace close',     noremap = true, silent = true },
		{ '<leader>wA', '<cmd>BufferCloseAllButCurrent<cr>', desc = '[wc] Workspace close all', noremap = true, silent = true },
	},
	opts = {},
	version = '^1.0.0',
} };
